...
import type { IShopDetail, IDiscount, IDiscountContent } from '@/types';
...
const reduction = computed(() => {
  const r = props.data.discounts.find((v) => v.type === DiscountEnum.Reduction)
  return r ? r.content: []
})
...
<template>
  <div class="shop-header">
    ...
    <div class="shop-header__anoucement op-ellipsis">公告: {{ data.announcement }}</div>
